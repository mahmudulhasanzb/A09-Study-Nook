      ...
      <div className="grow flex items-center justify-center p-4">
       ...
       c0-1.3-.1-2.7-.4-3.5z"
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-[#5c5654] dark:text-slate-400 font-medium">
              Don't have an account?{' '}
              <Link
                href="/register"
                className="text-[#b5622a] hover:text-[#a15323] dark:text-orange-400 dark:hover:text-orange-300 text-lg font-bold hover:underline transition-all"
              >
                Register
              </Link>
            </p>
